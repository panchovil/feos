module properties
   ...
   public :: operator(+), operator(-), operator(*), operator(**), operator(/), assignment(=)
   public :: print_scalar
...
contains
   ...
   ! =============================================================================
    ...
    function add_integer_scalar_left(self, to_add) result(add)
    ...
    function add_integer_scalar_right(to_add, self) result(add)
       integer, intent(in) :: to_add
       class(scalar_property), intent(in) :: self
       real(wp) :: add
       add =  self%val + to_add
   ...
   pure function add_real_scalar_left(self, to_add) result(add)
      class(scalar_property), intent(in) :: self
    ...
    pure function add_real_scalar_right(to_add, self) result(add)
       real(wp), intent(in) :: to_add
       class(scalar_property), intent(in) :: self
       real(wp) :: add
    ...
    pure function add_self_scalar(self, to_add) result(add)
       class(scalar_property), intent(in) :: self
    ...
    ! -------------------------------------------------------------------------
    function sub_integer_scalar_left(self, to_sub) result(sub)
       class(scalar_property), intent(in) :: self
    ...
    function sub_integer_scalar_right(to_sub, self) result(sub)
       integer, intent(in) :: to_sub
       class(scalar_property), intent(in) :: self
       real(wp) :: sub
       sub =  self%val - to_sub
   ...
   pure function sub_real_scalar_left(self, to_sub) result(sub)
      class(scalar_property), intent(in) :: self
    ...
    pure function sub_real_scalar_right(to_sub, self) result(sub)
       real(wp), intent(in) :: to_sub
       class(scalar_property), intent(in) :: self
       real(wp) :: sub
    ...
    pure function sub_self_scalar(self, to_sub) result(sub)
       class(scalar_property), intent(in) :: self
    ...
    !  Product procedures
    ! -------------------------------------------------------------------------
    pure function product_real_scalar_left(self, to_add) result(prod)
    ...
    pure function product_real_scalar_right(to_add, self) result(prod)
       class(scalar_property), intent(in) :: self
       real(wp), intent(in) :: to_add
       real(wp) :: prod
    ...
    pure function product_integer_scalar_left(self, to_add) result(prod)
    ...
    pure function product_integer_scalar_right(to_add, self) result(prod)
       class(scalar_property), intent(in) :: self
       integer, intent(in) :: to_add
       real(wp) :: prod
    ...
    !  Exponent procedures
    ! -------------------------------------------------------------------------
    pure function exponent_real_scalar_left(self, to_add) result(res)
       ! Producto entre un real y una propiedad escalar
       class(scalar_property), intent(in) :: self
       real(wp), intent(in) :: to_add
       real(wp) :: res
    ...
    pure function exponent_real_scalar_right(to_add, self) result(res)
       class(scalar_property), intent(in) :: self
       real(wp), intent(in) :: to_add
       real(wp) :: res
    ...
    pure function exponent_integer_scalar_left(self, to_add) result(res)
       ! Producto entre un integer y una propiedad escalar
       class(scalar_property), intent(in) :: self
       integer, intent(in) :: to_add
       real(wp) :: res
    ...
    pure function exponent_integer_scalar_right(to_add, self) result(res)
       class(scalar_property), intent(in) :: self
       integer, intent(in) :: to_add
       real(wp) :: res
    ...
    !  Division procedures
    ! -----------------------------------------------------------------------------
    pure function division_real_scalar_left(self, to_add) result(res)
       ! Producto entre un real y una propiedad escalar
       class(scalar_property), intent(in) :: self
       real(wp), intent(in) :: to_add
       real(wp) :: res
    ...
    pure function division_real_scalar_right(to_add, self) result(res)
       class(scalar_property), intent(in) :: self
       real(wp), intent(in) :: to_add
       real(wp) :: res
    ...
    pure function division_integer_scalar_left(self, to_add) result(res)
       ! Producto entre un integer y una propiedad escalar
       class(scalar_property), intent(in) :: self
       integer, intent(in) :: to_add
       real(wp) :: res
    ...
    pure function division_integer_scalar_right(to_add, self) result(res)
       class(scalar_property), intent(in) :: self
       integer, intent(in) :: to_add
       real(wp) :: res
    ...
    ! -------------------------------------------------------------------------
    subroutine set_value_scalar(self, value)
